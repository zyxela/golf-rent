...
import com.example.golf_rent.data.Authorization.checkUser
...
fun Authorization(navHostController: NavHostController) {
    ...
    Surface(
        ...
        Column(verticalArrangement = Arrangement.Center) {
            ...
            if (enter != null) {
                if (enter!!) {
                    if (sp.getBoolean("USER_STATUS", false)) {
                        navHostController.navigate(Screens.AdminPanelScreen.route)
                    } else {
                        navHostController.navigate(Screens.CatalogScreen.route)
                    }
                } else {
            ...
            Button(onClick = {
                GlobalScope.launch { enter = checkUser(loginText, password, context) }
            }) {
                Text(
                    text = "Войти",
